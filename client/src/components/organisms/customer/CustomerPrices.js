...
import { setCustomerPrices } from 'utils/apiHandlers/customers/update';
...
const CustomerPrices = ({ data, globalPrices, userId }) => {
  ...
  <div>
   <Formik
    ...
    onSubmit={async values => {
     ...
     await setCustomerPrices(userId, updatePrices, () =>
      dispatch(setSpinner(false)),
     );
    }}
    initialValues={{
     manHour: globalPrices.manHour - discounts.manHour,

     glossOneSide: globalPrices.gloss.oneSide - discounts.gloss.oneSide,
     glossBothSides: globalPrices.gloss.bothSides - discounts.gloss.bothSides,
     glossOneGlossSecondSemigloss:
      globalPrices.gloss.oneGlossSecondSemigloss -
      discounts.gloss.oneGlossSecondSemigloss,

     semiGlossOneSide:
      globalPrices.semiGloss.oneSide - discounts.semiGloss.oneSide,
     semiGlossBothSides:
      globalPrices.semiGloss.bothSides - discounts.semiGloss.bothSides,

     customerGlossOneSide:
      globalPrices.customerMaterial.gloss.oneSide -
      discounts.customerMaterial.gloss.oneSide,
     customerGlossBothSides:
      globalPrices.customerMaterial.gloss.bothSides -
      discounts.customerMaterial.gloss.bothSides,
     customerGlossOneGlossSecondSemigloss:
      globalPrices.customerMaterial.gloss.oneGlossSecondSemigloss -
      discounts.customerMaterial.gloss.oneGlossSecondSemigloss,

     customerSemiGlossOneSide:
      globalPrices.customerMaterial.semiGloss.oneSide -
      discounts.customerMaterial.semiGloss.oneSide,
     customerSemiGlossBothSides:
      globalPrices.customerMaterial.semiGloss.bothSides -
      discounts.customerMaterial.semiGloss.bothSides,

     customerMordant:
      globalPrices.customerMaterial.semiGloss.mordant -
      discounts.customerMaterial.semiGloss.mordant,
     customerVeneerColorless:
      globalPrices.customerMaterial.semiGloss.veneerColorless -
      discounts.customerMaterial.semiGloss.veneerColorless,

     customerMilledElement:
      globalPrices.customerMaterial.milledElement -
      discounts.customerMaterial.milledElement,
     customerMilledElementBothSides:
      globalPrices.customerMaterial.milledElementBothSides -
      discounts.customerMaterial.milledElementBothSides,

     board22: globalPrices.board[22] - discounts.board[22],
     board25: globalPrices.board[25] - discounts.board[25],
     board28: globalPrices.board[28] - discounts.board[28],
     board30: globalPrices.board[30] - discounts.board[30],
     board38: globalPrices.board[38] - discounts.board[38],

     chamfering: globalPrices.chamfering - discounts.chamfering,
     backMilling: globalPrices.backMilling - discounts.backMilling,
     milledElement: globalPrices.milledElement - discounts.milledElement,
     milledElementBothSides:
      globalPrices.milledElementBothSides - discounts.milledElementBothSides,
     milledHandle: globalPrices.milledHandle - discounts.milledHandle,
     milledPartHandle:
      globalPrices.milledPartHandle - discounts.milledPartHandle,
     millingHandle: globalPrices.millingHandle - discounts.millingHandle,
     paintHandle: globalPrices.paintHandle - discounts.paintHandle,
     zobalHandle: globalPrices.zobalHandle - discounts.zobalHandle,
     hingeHole: globalPrices.hingeHole - discounts.hingeHole,
    }}
    render={({
     handleSubmit,
     handleChange,
       ...
       <div>
        <div>
         <Row justify="flex-start">
          <div>
           <Heading>Cennik indywidualny</Heading>
           <Row justify="flex-start">
            <div>
             <div>
              ...
              >
               ...
               <Form.Control
                ...
                onBlur={handleBlur}
                isValid={
                 touched.semiGlossBothSides && !errors.semiGlossBothSides
                }
                placeholder="-"
                className={
             ...
             <div>
              ...
              <StyledWrapper className="greyOnHover" controlId="formHingeHole">
               ...
               <Form.Control
                ...
                placeholder="-"
                className={
                 errors.hingeHole && touched.hingeHole && 'is-invalid'
                }
               />
              ...
              <StyledWrapper className="greyOnHover" controlId="formChamfering">
               ...
               <Form.Control
                ...
                placeholder="-"
                className={
                 errors.chamfering && touched.chamfering && 'is-invalid'
                }
               />
              ...
              <StyledWrapper className="greyOnHover" controlId="formManHour">
               <Form.Label>
              ...
              <StyledWrapper className="greyOnHover" controlId="formBoard30">
               ...
               <Form.Control
                ...
                placeholder="-"
                className={errors.board30 && touched.board30 && 'is-invalid'}
               />
           ...
           <div>
            ...
            <StyledWrapper className="greyOnHover" controlId="formPaintHandle">
             ...
             <Form.Control
              ...
              placeholder="-"
              className={
               errors.paintHandle && touched.paintHandle && 'is-invalid'
              }
             />
